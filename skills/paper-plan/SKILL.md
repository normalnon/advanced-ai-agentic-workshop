---
name: paper-plan
description: "Generate a structured, section-by-section paper outline from: **$ARGUMENTS**"
---

# paper-plan

> **Path within category:** `skills/skills-codex-gemini-review/paper-plan/SKILL.md`
