---
name: paper-figure
description: "Generate all figures and tables for a paper based on: **$ARGUMENTS**"
---

# paper-figure

> **Path within category:** `skills/skills-codex-gemini-review/paper-figure/SKILL.md`
