...
description: "Verify that every claim in the paper matches raw evidence for: **$ARGUMENTS**"
---

# paper-claim-audit

> **Path within category:** `skills/skills-codex/paper-claim-audit/SKILL.md`
