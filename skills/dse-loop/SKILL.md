---
name: dse-loop
description: "Autonomously explore a design space: run → analyze → pick next parameters → repeat, until the objective is met or timeout is reached. Designed for ..."
---

# dse-loop

> **Path within category:** `skills/dse-loop/SKILL.md`
