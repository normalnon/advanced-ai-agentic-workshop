---
name: elevenlabs-tts
description: "Generate professional audio files from text using ElevenLabs' advanced text-to-speech API. The skill provides pre-configured voice presets with sen..."
---
