---
name: drawio-skill
description: Consolidated expert tools and guidelines for drawio skill.
---

# 🛠️ Consolidated Skills: DRAWIO-SKILL
This playbook contains a combined registry of expert capabilities for **drawio-skill**.

## 1. Expert Skill: Core
> **Path within category:** `skills/drawio-skill/SKILL.md`
