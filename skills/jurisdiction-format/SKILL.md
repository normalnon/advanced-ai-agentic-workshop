...
description: "Compile the patent application into filing-ready format based on: **$ARGUMENTS**"
---

# jurisdiction-format

> **Path within category:** `skills/skills-codex/jurisdiction-format/SKILL.md`
