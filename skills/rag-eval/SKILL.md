---
name: rag-eval
description: "Replace the 'tweak → squint → swap model → burn credits' loop with a single command that runs a grid of eval variants on the user's gold-set, ranks..."
---
