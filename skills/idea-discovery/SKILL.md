---
name: idea-discovery
description: "Orchestrate a complete idea discovery workflow for: **$ARGUMENTS**"
---

# idea-discovery

> **Path within category:** `skills/skills-codex-gemini-review/idea-discovery/SKILL.md`
