---
name: sorted
description: "Automates [getSorted.de](https://app.getsorted.de/) via real Chrome Beta browser for invoicing, expense tracking, and German tax report submissions."
---
