---
name: site-diagnosis
description: "You are conducting a structured diagnostic interview to prepare for a website consultation. The client is building (or has built) a website using A..."
---
