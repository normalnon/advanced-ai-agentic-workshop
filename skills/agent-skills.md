---
name: agent-skills
description: Consolidated expert tools and guidelines for agent skills.
---

# 🛠️ Consolidated Skills: AGENT-SKILLS
This playbook contains a combined registry of expert capabilities for **agent-skills**.

## 1. Expert Skill: idea-refine
> **Path within category:** `skills/idea-refine/SKILL.md`
...
## 2. Expert Skill: debugging-and-error-recovery
> **Path within category:** `skills/debugging-and-error-recovery/SKILL.md`
...
## 3. Expert Skill: using-agent-skills
> **Path within category:** `skills/using-agent-skills/SKILL.md`
...
## 4. Expert Skill: test-driven-development
> **Path within category:** `skills/test-driven-development/SKILL.md`
...
## 5. Expert Skill: planning-and-task-breakdown
> **Path within category:** `skills/planning-and-task-breakdown/SKILL.md`
...
## 6. Expert Skill: incremental-implementation
> **Path within category:** `skills/incremental-implementation/SKILL.md`
...
## 7. Expert Skill: api-and-interface-design
> **Path within category:** `skills/api-and-interface-design/SKILL.md`
...
## 8. Expert Skill: ci-cd-and-automation
> **Path within category:** `skills/ci-cd-and-automation/SKILL.md`
...
## 9. Expert Skill: context-engineering
> **Path within category:** `skills/context-engineering/SKILL.md`
...
## 10. Expert Skill: frontend-ui-engineering
> **Path within category:** `skills/frontend-ui-engineering/SKILL.md`
...
## 11. Expert Skill: shipping-and-launch
> **Path within category:** `skills/shipping-and-launch/SKILL.md`
...
## 12. Expert Skill: spec-driven-development
> **Path within category:** `skills/spec-driven-development/SKILL.md`
...
## 13. Expert Skill: code-review-and-quality
> **Path within category:** `skills/code-review-and-quality/SKILL.md`
...
## 14. Expert Skill: security-and-hardening
> **Path within category:** `skills/security-and-hardening/SKILL.md`
...
## 15. Expert Skill: deprecation-and-migration
> **Path within category:** `skills/deprecation-and-migration/SKILL.md`
...
## 16. Expert Skill: interview-me
> **Path within category:** `skills/interview-me/SKILL.md`
...
## 17. Expert Skill: code-simplification
> **Path within category:** `skills/code-simplification/SKILL.md`
...
## 18. Expert Skill: doubt-driven-development
> **Path within category:** `skills/doubt-driven-development/SKILL.md`
...
## 19. Expert Skill: source-driven-development
> **Path within category:** `skills/source-driven-development/SKILL.md`
...
## 20. Expert Skill: performance-optimization
> **Path within category:** `skills/performance-optimization/SKILL.md`
...
## 21. Expert Skill: browser-testing-with-devtools
> **Path within category:** `skills/browser-testing-with-devtools/SKILL.md`
...
## 22. Expert Skill: git-workflow-and-versioning
> **Path within category:** `skills/git-workflow-and-versioning/SKILL.md`
...
## 23. Expert Skill: documentation-and-adrs
> **Path within category:** `skills/documentation-and-adrs/SKILL.md`
