...
description: "Generate one comprehensive Chinese cheat sheet per invocation: formulas + derivations + from-scratch code + 25 高频题. Output passes cross-model math/..."
---

# interview-cheatsheet

> **Path within category:** `skills/interview-cheatsheet/SKILL.md`
