...
description: "Systematically design ablation studies that answer the questions reviewers will ask. Codex leads the design (reviewer perspective), CC reviews feas..."
---

# ablation-planner

> **Path within category:** `skills/ablation-planner/SKILL.md`
