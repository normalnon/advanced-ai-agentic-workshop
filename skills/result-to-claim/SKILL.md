...
description: "Experiments produce numbers; this gate decides what those numbers *mean*. Collect results from available sources, get a secondary Codex judgment, t..."
---

# result-to-claim

> **Path within category:** `skills/skills-codex/result-to-claim/SKILL.md`
